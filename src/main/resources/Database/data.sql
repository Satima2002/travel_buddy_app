...
INSERT INTO blog (title, country, city, season_visited, description)
VALUES
...
INSERT INTO blog (title, country, city, season_visited, description,  security_level_rating)
VALUES
    ('Exploring the Big Apple', 'USA', 'New York', 'Summer', 'New York City was bustling with energy!', 'High'),
    ('Adventures in Paris', 'France', 'Paris', 'Spring', 'The Eiffel Tower was breathtaking!', 'Medium'),
    ('A Winter Retreat in the Swiss Alps', 'Switzerland', 'Zurich', 'Winter', 'The skiing conditions were perfect.', 'High'),
    ('Sunny Days in Barcelona', 'Spain', 'Barcelona', 'Summer', 'The beaches were beautiful.', 'Low'),
    ('Discovering Tokyo', 'Japan', 'Tokyo', 'Spring', 'The cherry blossoms were in full bloom.', 'Medium'),
    ('Weekend Getaway to Rome', 'Italy', 'Rome', 'Fall', 'The historical sites were awe-inspiring.', 'High'),
    -- Add more sample data here
    ('Exploring the Great Barrier Reef', 'Australia', 'Cairns', 'Summer', 'Snorkeling with colorful fish was unforgettable.', 'High'),
    ('City Lights of Hong Kong', 'China', 'Hong Kong', 'Winter', 'The skyline at night was mesmerizing.', 'Medium'),
    ('Hiking Adventures in the Rocky Mountains', 'Canada', 'Banff', 'Fall', 'The views from the mountain peaks were breathtaking.', 'High'),
    ('Cultural Immersion in Kyoto', 'Japan', 'Kyoto', 'Spring', 'Experiencing traditional tea ceremonies was enlightening.', 'Medium'),
    ('Island Paradise in the Maldives', 'Maldives', 'Male', 'Summer', 'Relaxing on pristine beaches was pure bliss.', 'Low'),
    ('Exploring the Ancient Ruins of Athens', 'Greece', 'Athens', 'Spring', 'Learning about Greek history was fascinating.', 'High');
select * from blog;
